...
class UpdateMailTemplatePartRequest extends FormRequest
{
    ...
    public function rules(
        ...
        return [
            ...
            'section.blocks.normalCustomer.signatureImageDataUrl' => ['nullable', 'string', 'max:500000'],
            ...
            'section.blocks.keyAccountCustomer.signatureImageDataUrl' => ['nullable', 'string', 'max:500000'],
