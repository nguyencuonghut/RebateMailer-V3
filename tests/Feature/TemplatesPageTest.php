    ...
    public function test_templates_page_renders_through_inertia_for_user_with_manage_permission(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('templateParts.2.code', 'representative-signature')
                ->where('templateParts.2.type', 'representative-signature')
                ->where('templateParts.3.code', 'tong-hop')
                ->where('templateParts.3.type', 'tong-hop-table')
                ->where('templateParts.3.sourceSheet', 'Tổng hợp')
                ->where('templateParts.4.code', 'khoan-npp')
                ->where('templateParts.4.type', 'khoan-npp-table')
                ->where('templateParts.5.code', 'cam-ca')
                ->where('templateParts.5.type', 'cam-ca-table')
                ->where('templateParts.6.code', 'key-account')
                ->where('templateParts.6.type', 'key-account-table')
                ->where('templateList', [])
    ...
    public function test_templates_page_can_render_template_list_and_active_state_from_database(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->has('canvasComposition.partSelections', 7)
                ...
                ->where('canvasComposition.partSelections.2.partType', 'representative-signature')
                ->where('canvasComposition.partSelections.3.partType', 'tong-hop-table')
                ->where('canvasComposition.partSelections.3.contentSummary.rowCount', 0)
    ...
    public function test_templates_page_can_render_key_account_table_preview_from_real_aggregate_payload(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('keyAccountTablePreview.title', 'Chiết khấu tháng 02.2026')
    ...
    public function test_templates_page_can_switch_key_account_preview_to_selected_customer_record(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('keyAccountTablePreview.title', 'Chiết khấu tháng 03.2026')
