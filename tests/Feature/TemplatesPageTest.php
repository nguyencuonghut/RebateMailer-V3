    ...
    public function test_templates_page_renders_through_inertia_for_user_with_manage_permission(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('templateParts.6.code', 'representative-signature')
                ->where('templateParts.6.type', 'representative-signature')
                ->where('templateList', [])
    ...
    public function test_templates_page_can_render_template_list_and_active_state_from_database(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('canvasComposition.partSelections.6.partType', 'representative-signature')
                ->where('canvasComposition.partSelections.6.kind', 'composite')
