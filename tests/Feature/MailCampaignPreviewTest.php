    ...
    public function test_mail_page_can_render_full_preview_for_selected_recipient(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('selectedRecipientPreview.greeting.renderedHtml', 'Kính gửi <strong>90300 - Công ty A,</strong><br>Địa chỉ: <strong>Địa chỉ A</strong>')
                ...
                ->where('selectedRecipientPreview.html', fn (string $html): bool => str_contains($html, '<!DOCTYPE html>')
                    && str_contains($html, 'Kính gửi <strong>90300 - Công ty A,</strong><br>Địa chỉ: <strong>Địa chỉ A</strong>')
